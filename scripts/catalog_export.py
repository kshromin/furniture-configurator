...
HELP_TEXT = [
    ...
    '   «Высота» = толщина плиты; «Длинна» и «Ширина» = габарит ЛИСТА этого материала.',
    '   Деталь конфигуратор считает влезающей, если она на 10 мм меньше листа по каждой стороне',
    '   (обзол при пилении); не влезает — предупреждение под ценой. Пусто = ограничения нет.',
