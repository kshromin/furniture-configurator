...
HELP_TEXT = [
    ...
    '12. УДАЛИТЬ позицию: напишите в колонке «Цена» слово «удалить» (строку не стирайте — чего',
    '    нет в файле, то загрузка просто не трогает). Удалять можно только СВОИ позиции: то, что',
    '    заведено в самой программе (верхние таблицы), не удаляется. Отчёт покажет, что удалено.',
